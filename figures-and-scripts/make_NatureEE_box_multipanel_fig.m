function make_NatureEE_box_multipanel_fig(workingIndexes, gatherDataOverride, rezip, focalQuantile)

% function for making figures of phi and m_e over time and for parametric
...
load('ws_NatureEEboxData_202971-203170.mat'); % contains summary of GWC times and phi values at GWC
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function effNumLoci = calcEffNumLoci( afDiffData, meanSdata )
...
for i = 1:n
    ...
    if afd <= 0
        ...
        effectiveS = invertOneLocusEq(avgp, SD_MOVE);
        
        % note that (1 + meanSdata(i))^effNumLoci(i) == 1 + effectiveS
        
        effNumLoci(i) = log(1 + effectiveS) / log(1 + meanSdata(i));
    end
end
clear('parameters');
